...
chargeBins = ["y[0,5]/", "y[0,1]/", "y[1,3]/", "y[3,5]/"]
    ...
    for sin in range(len(sin2w_values)):
        ...
        for ch in range(len(chargeBins)):
            ...
            for cos in costhetaBins:
                AFB_data = dyb.GetHist(0, channel+chargeBins[ch]+"AFBrecoil_default"+cos+"(x)", "cosbins")
                AFB_mc = dyb.GetHist(1, channel+chargeBins[ch]+"AFBrecoil_default"+cos+"(x)", "cosbins")
                #AFB_mc_sin2w = dyb.GetHist(1, channel+chargeBins[ch]+"AFBrecoil_default"+cos+"(x)", "cosbins suffix:_sthw2_%i:dy" % iSin)
                AFB_mc_sin2w = dyb.GetHist(1, channel+chargeBins[ch]+"AFBrecoil_default"+cos+"(x)", "cosbins suffix:_Recoil_weakNLOHO_s2eff_%i:dy" % (iSin * 1e5))
            ...
            for syst in range(len(list_syst[term])):
                ...
                for ch in range(len(chargeBins)):
                    ...
                    if "stat_Data" in systkey:
                        for cos in costhetaBins:
                            AFB_data_nominal = dyb.GetHist(0, channel+chargeBins[ch]+"AFBrecoil_default"+cos+"(x)", "cosbins")
                            for iBin in range(nMassbins):
                        ...
                        for cos in costhetaBins:
                            AFB_mc_nominal = dyb.GetHist(1, channel+chargeBins[ch]+"AFBrecoil_default"+cos+"(x)", "cosbins")
                            for iBin in range(nMassbins):
                        ...
                        for cos in costhetaBins:
                            ...
                            AFB_mc_syst = dyb.GetHist(1, channel+chargeBins[ch]+"AFBrecoil_default"+cos+"(x)", "cosbins "+syststr)
