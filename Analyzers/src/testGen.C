...
void testGen::executeEventFromParameter(AnalyzerParameter param){
  ...
  for(unsigned int i=0; i<gens.size(); i++){
    ...
    if(muons.at(0).Charge() > 0){               //TriggerSafePtCut//
      if(gens.at(i).PID() == 13 && gens.at(i).Pt() > 0.1 && fabs(gens.at(i).Eta()) < 2.4 && gens.at(i).Status() == 1 && 80 < mass_ll && mass_ll < 100) GenMuons_minus.push_back(gens.at(i));
    }
    else{                                       //TriggerSafePtCut//
      if(gens.at(i).PID() == -13 && gens.at(i).Pt() > 0.1 && fabs(gens.at(i).Eta()) < 2.4 && gens.at(i).Status() == 1 && 80 < mass_ll && mass_ll < 100) GenMuons_plus.push_back(gens.at(i));
    }
  }
  ...
  for(unsigned int i=0; i<gens.size(); i++){
    ...
    if(muons_ID.at(0).Charge() > 0){            //TriggerSafePtCut//
      if(gens.at(i).PID() == 13 && gens.at(i).Pt() > 0.01 && fabs(gens.at(i).Eta()) < 15.0 && gens.at(i).Status() == 1 && 80 < mass_ll && mass_ll < 100) GenMuons_minus.push_back(gens.at(i));
    }
    else{                                            //TriggerSafePtCut//
      if(gens.at(i).PID() == -13 && gens.at(i).Pt() > 0.01 && fabs(gens.at(i).Eta()) < 15.0 && gens.at(i).Status() == 1 && 80 < mass_ll && mass_ll < 100) GenMuons_plus.push_back(gens.at(i));
    }
  }
  ...
  for(unsigned int i=0; i<GenMuons_plus.size(); i++){
    ...
    FillHist("2_GenMuons_plus_"+TString::Itoa(i,10)+"_eta", GenMuons_plus.at(i).Eta(),1, 50, -12.5, 12.5);
  ...
  for(unsigned int i=0; i<GenMuons_minus.size(); i++){
    ...
    FillHist("2_GenMuons_minus_"+TString::Itoa(i,10)+"_eta", GenMuons_minus.at(i).Eta(),1, 50, -12.5, 12.5);
