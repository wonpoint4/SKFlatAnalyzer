...
void Func(TString setup,TString histname,TString option){
  ...
  savename="smp/"+savename;
  if(option.Contains("nodefault")){
    option.ReplaceAll("nodefault","");
  }else{
    option+=" preliminary sysname:totalsys sysdetail";
    if(!histname.Contains("AFB")) option+=" 2:sysleg";
  }
...
void PlotAll(){
  ...
  threads.push_back(Run("mimu","mm201[678][ab]?/0bjet/m[52,3000]/AFB(m)","logx rebin:{52,56,60,65,70,74,77,80,82,84,86,88,89,90,91,92,93,94,96,98,100,103,106,110,115,120,130,140,150,175,200,240,280,340,400,500,600,700,800,1000,3000} TLleg 1:ymin:-0.19 1:ymax:0.39 blind:76,106"));
  threads.push_back(Run("mimu","mm201[678][ab]?/0bjet/m[52,80]/AFB(pt)","logx rebin:{0,2,4,6,8,10,12,14,16,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("mimu","mm201[678][ab]?/0bjet/m[80,100]/AFB(pt)","logx rebin:{0,2,4,6,8,10,12,14,16,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("mimu","mm201[678][ab]?/0bjet/m[100,3000]/AFB(pt)","logx rebin:{0,2,4,6,8,10,12,14,16,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098 BRleg"));
  ...
  threads.push_back(Run("mimu","mm201[678][ab]?/nbjet/m[52,3000]/AFB(m)","logx rebin:{52,60,70,77,82,86,89,91,93,96,100,106,115,130,150,200,280,400,600,3000} TLleg 1:ymin:-0.099 1:ymax:0.099 blind:76,106"));
  threads.push_back(Run("mimu","mm201[678][ab]?/nbjet/m[52,80]/AFB(pt)","logx rebin:{0,2,8,14,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("mimu","mm201[678][ab]?/nbjet/m[80,100]/AFB(pt)","logx rebin:{0,2,8,14,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("mimu","mm201[678][ab]?/nbjet/m[100,3000]/AFB(pt)","logx rebin:{0,2,8,14,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  ...
  threads.push_back(Run("miel","ee201[678][ab]?/0bjet/m[52,3000]/AFB(m)","logx rebin:{52,56,60,65,70,74,77,80,82,84,86,88,89,90,91,92,93,94,96,98,100,103,106,110,115,120,130,140,150,175,200,240,280,340,400,500,600,700,800,1000,3000} TLleg 1:ymin:-0.19 1:ymax:0.39 blind:76,106"));
  threads.push_back(Run("miel","ee201[678][ab]?/0bjet/m[52,80]/AFB(pt)","logx rebin:{0,2,4,6,8,10,12,14,16,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("miel","ee201[678][ab]?/0bjet/m[80,100]/AFB(pt)","logx rebin:{0,2,4,6,8,10,12,14,16,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("miel","ee201[678][ab]?/0bjet/m[100,3000]/AFB(pt)","logx rebin:{0,2,4,6,8,10,12,14,16,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098 BRleg"));
  ...
  threads.push_back(Run("miel","ee201[678][ab]?/nbjet/m[52,3000]/AFB(m)","logx rebin:{52,60,70,77,82,86,89,91,93,96,100,106,115,130,150,200,280,400,600,3000} TLleg 1:ymin:-0.099 1:ymax:0.099 blind:76,106"));
  threads.push_back(Run("miel","ee201[678][ab]?/nbjet/m[52,80]/AFB(pt)","logx rebin:{0,2,8,14,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("miel","ee201[678][ab]?/nbjet/m[80,100]/AFB(pt)","logx rebin:{0,2,8,14,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
  threads.push_back(Run("miel","ee201[678][ab]?/nbjet/m[100,3000]/AFB(pt)","logx rebin:{0,2,8,14,20,32,60,120,650} xmax:650 1:ymax:0.098 1:ymin:-0.098"));
