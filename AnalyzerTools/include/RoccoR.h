...
struct RoccoR_CrystalBall{
    ...
    RoccoR_CrystalBall():m(0),s(1),a(10),n(10){
	init();
    }
...
struct RoccoR_RocRes{
	...
	std::vector<RoccoR_CrystalBall> cb;
...
class RoccoR{
 ...
 private:
	...
	const RoccoR_RocRes& getRes(int s=0, int m=0) const {return RC[s][m].RR;}
	...
	double kGenSmear(double pt, double eta, double v, double u, RoccoR_RocRes::TYPE TT=RoccoR_RocRes::Data, int s=0, int m=0) const;
