...
struct RocelecoR_CrystalBall{
    ...
    RocelecoR_CrystalBall():m(0),s(1),a(10),n(10){
	init();
    }
...
struct RocelecoR_RocRes{
	...
	std::vector<RocelecoR_CrystalBall> cb;
...
class RocelecoR{
 ...
 private:
	...
	const RocelecoR_RocRes& getRes(int s=0, int m=0) const {return RC[s][m].RR;}
	...
	double kGenSmear(double pt, double eta, double v, double u, RocelecoR_RocRes::TYPE TT=RocelecoR_RocRes::Data, int s=0, int m=0) const;
